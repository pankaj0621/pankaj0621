...
# ===========================================================================
HOST = "pankaj"   # shown as  pankaj@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Freelance Web Developer"),
    ("kv", "Prev", "Backend Intern @ Zorvyn FinTech"),
    ("kv", "Also", "Intern @ DecodeLabs"),
    ("kv", "Edu", "B.Tech CSE, BIT Sindri"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Vite, TypeScript"),
    ("kv", "Backend", "Node.js, Express, FastAPI"),
    ("kv", "Database", "Supabase, MongoDB"),
    ("kv", "Cloud", "Vercel, Render, Git"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built FinSight - AI financial health scorer for SMEs"),
    ("bul", "Building Skill Bloom, a React + Supabase SaaS"),
    ("bul", "Open-source contributor, Hushh Hiring Challenge"),
]
